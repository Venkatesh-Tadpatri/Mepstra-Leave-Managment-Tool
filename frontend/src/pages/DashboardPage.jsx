        ...
        <motion.div variants={fadeUp} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          {filteredOnLeave.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-10 text-gray-300">
              ...
              <p className="text-sm">No Employees Used Leave today{buFilter ? " for this business unit" : ""}</p>
            </div>
          ) : (
                    ...
                    {myLeaves.map((l, i) => {
                      ...
                      return (
                        <tr key={l.id}
                          ...
                          <td className="px-4 py-3.5 text-gray-500 max-w-[160px] truncate cursor-help" title={l.reason || ""}>{l.reason}</td>
                          <td className="px-4 py-3.5">
